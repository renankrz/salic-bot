...
Preencha os campos (Mecanismo, Proponente, PRONAC, Pasta de Clientes, CPF e Senha) e clique em **RODAR**. As credenciais podem ser salvas no keyring do sistema operacional marcando "Lembrar credenciais". Para executar em modo dry run (preenche os campos mas cancela em vez de salvar), marque a caixa **Não salvar**.
